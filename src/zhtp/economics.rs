use crate::zhtp::zk_consensus::ZkValidator;
use anyhow::Result;
...
impl ZhtpEconomics {
    ...
    pub fn new() -> Self {
        ...
        let params = EconomicParams {
            ...
            min_validator_stake: 32_000_000, // 32 ZHTP minimum stake
...
mod tests {
    ...
    async fn test_validator_rewards() -> Result<()> {
        ...
        let validator = ZkValidator {            encrypted_identity: vec![1, 2, 3],
            ...
            metrics: crate::zhtp::zk_consensus::ZkNetworkMetrics::new(0.9),
            registered_at: 0,
            last_activity: 0,
            status: crate::zhtp::zk_consensus::ValidatorStatus::Active,
        };
